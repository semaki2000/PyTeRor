...
@pytest.mark.parametrize('transform, parametrized_constant_0', [('INIT_TRANSFORM', 'FIELD f PARAMETER f.roff INIT_FILES:f%d.grdecl OUTPUT_TRANSFORM:'), ('OUTPUT_TRANSFORM', 'FIELD f PARAMETER f.roff INIT_FILES:f%d.grdecl OUTPUT_TRANSFORM:'), ('INIT_TRANSFORM', 'FIELD f PARAMETER f.roff INIT_FILES:f%d.grdecl INIT_TRANSFORM:'), ('OUTPUT_TRANSFORM', 'FIELD f PARAMETER f.roff INIT_FILES:f%d.grdecl INIT_TRANSFORM:')])
